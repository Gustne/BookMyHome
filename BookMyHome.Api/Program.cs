...
builder.Services.AddScoped<IBookingQuery, IBookingQuery>();
builder.Services.AddScoped<IBookingDomainService, IBookingDomainService>();
...
builder.Services.AddScoped<BookMyHomeContext>();
